...
function serializeAvmArgs(runParams, air, prevData, data, callResults) {
    ...
    for (var _i = 0, callResults_1 = callResults; _i < callResults_1.length; _i++) {
        var _a = callResults_1[_i], key = _a[0], callResult = _a[1];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fn(avmArg)];
                case 1:
                    rawResult = _a.sent();
                    return [2 /*return*/, deserializeAvmResult(rawResult)];
                case 2:
                    e_1 = _a.sent();
                    return [2 /*return*/, {
                            retCode: -1,
...
//# sourceMappingURL=avmHelpers.js.map
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                args = JSON.stringify([air]);
                                return [4 /*yield*/, this._fluenceAppService.callService('avm', 'ast', args, undefined)];
                            case 1:
                                rawRes = _a.sent();
                                try {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (connection instanceof FluenceConnection_1.FluenceConnection) {
                    ...
                    return [4 /*yield*/, FluenceConnection_1.RelayConnection.createConnection({

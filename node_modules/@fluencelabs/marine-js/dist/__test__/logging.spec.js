    ...
    it('Testing logging level', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    res = faas.call('log_' + level, [], undefined);
                    // assert
    ...
    it('Testing logging level by passing env: %0', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    res1 = faas.call('log_error', [], undefined);
                    res2 = faas.call('log_warn', [], undefined);
                    res3 = faas.call('log_info', [], undefined);
                    res4 = faas.call('log_debug', [], undefined);
                    res5 = faas.call('log_trace', [], undefined);
                    // assert

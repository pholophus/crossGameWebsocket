...
describe('Fluence app service tests', function () {
    it('Testing greeting service', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    res = faas.call('greeting', ['test'], undefined);
                    // assert
    ...
    it('Testing greeting service with object args', function () { return __awaiter(void 0, void 0, void 0, function () {
        var marine, greeting, faas, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, loadWasmModule(path_1.default.join(__dirname, '../../dist/marine-js.wasm'))];
                ...
                case 3:
                    _a.sent();
                    res = faas.call('greeting', { name: 'test' }, undefined);
                    // assert
                    expect(res).toBe('Hi, test');
                    return [2 /*return*/];
            }
    ...
    it('Testing greeting service with records', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    greetingRecordResult = faas.call('greeting_record', [], undefined);
                    voidResult = faas.call('void_fn', [], undefined);
                    // assert
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, avm_1.callAvm)(function (args) { return testAvmFaaS.call('invoke', args, undefined); }, {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    result = marine.call('sqlite3_exec', [dbHandle, 'CREATE VIRTUAL TABLE users USING FTS5(body)', 0, 0], undefined);
                    expect(result).toMatchObject({ err_msg: '', ret_code: 0 });
                    result = marine.call('sqlite3_exec', [dbHandle, "INSERT INTO users(body) VALUES('AB'), ('BC'), ('CD'), ('DE')", 0, 0], undefined);
                    expect(result).toMatchObject({ err_msg: '', ret_code: 0 });
                    result = marine.call('sqlite3_exec', [dbHandle, "SELECT * FROM users WHERE users MATCH 'A* OR B*'", 0, 0], undefined);
                    expect(result).toMatchObject({ err_msg: '', ret_code: 0 });
                    return [2 /*return*/];
            }
        });
    ...
    it.skip('Testing redis wasm', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    _a.sent();
                    result1 = marine.call('invoke', ['SET A 10'], undefined);
                    result2 = marine.call('invoke', ['SADD B 20'], undefined);
                    result3 = marine.call('invoke', ['GET A'], undefined);
                    result4 = marine.call('invoke', ['SMEMBERS B'], undefined);
                    result5 = marine.call('invoke', ["eval \"redis.call('incr', 'A') return redis.call('get', 'A') * 8 + 5\"  0"], undefined);
    ...
    it('Testing service which fails', function () { return __awaiter(void 0, void 0, void 0, function () {
        var marine, failing, faas, e_1, re;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, loadWasmModule(path_1.default.join(__dirname, '../../dist/marine-js.wasm'))];
                case 1:
                    marine = _a.sent();
                    return [4 /*yield*/, loadWasmModule(path_1.default.join(examplesDir, './failing/artifacts/failing.wasm'))];
                case 2:
                    failing = _a.sent();
                    faas = new FaaS_1.FaaS(marine, failing, 'srv');
                    return [4 /*yield*/, faas.init()];
                ...
                case 5:
                    _a.trys.push([5, 7, , 8]);
                    return [4 /*yield*/, faas.call('failing', [], undefined)];
                case 6:
                    _a.sent();
                ...
                case 7:
                    e_1 = _a.sent();
                    // assert
                    expect(e_1).toBeInstanceOf(WebAssembly.RuntimeError);
                    re = e_1;
    ...
    it('Checking error when calling non-existent function', function () { return __awaiter(void 0, void 0, void 0, function () {
        var marine, greeting, faas, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, loadWasmModule(path_1.default.join(__dirname, '../../dist/marine-js.wasm'))];
                case 1:
                ...
                case 5:
                    _a.trys.push([5, 7, , 8]);
                    return [4 /*yield*/, faas.call('do_not_exist', [], undefined)];
                case 6:
                    _a.sent();
                    // should never succeed
                    expect(true).toBe(false);
                ...
                case 7:
                    e_2 = _a.sent();
                    // assert
                    expect(e_2).toBeInstanceOf(Error);
                    expect(e_2.message).toBe('marine-js failed with: Error calling module function: function with name `do_not_exist` is missing');
                    return [3 /*break*/, 8];
                case 8: return [2 /*return*/];
            }
        });
